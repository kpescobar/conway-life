...
public class Player implements ActionListener, ChangeListener {
  ...
  private static final String SETUP_BUTTON = "Populate";
  ...
  private static final int GENERATION_DELAY = 150;
  ...
  private void step() {
    ...
    surface.setField(life.getField());
    SwingUtilities.invokeLater(() -> 
      step.setText(String.format(STEP_BUTTON, life.getGeneration())));
  }
